...
public class ArchivoObjetos implements IRenta {
    ...
    private void guardarLista() throws IOException {
        ...
        try {
            ...
            throw new IOException("No es posible abrir o crear el archivo para escritura");
    ...
    private void leerLista() throws IOException {
        ...
        if (!this.archivo.exists()) {
            ...
            try {
                ...
                throw new IOException("El archivo no existe o no permite su lectura");
            } catch (ClassNotFoundException ex) {
                throw new IOException("El contenido del archcio no tiene el formato correcto para una lista");
            } finally {
                if (ois != null) {
                    ois.close();
                }
